<script setup>
    ...
    // computedProperty que actualiza en tiempo real el total a pagar en el carrito (v63)
    const totalPagar = computed( () => {
        return props.carrito.reduce( (total, producto) => total + (producto.cantidad * producto.precio), 0)
    })
    
    // el actualizador del total a pagar tb funcionaria con una funcion normal en vez de un computedProperty (v63)
    // const totalPagar = () => props.carrito.reduce( (total, producto) => total + (producto.cantidad * producto.precio), 0)
